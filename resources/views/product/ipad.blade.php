...
<div class="container my-4" style="padding-top: 50px;padding-left:20px;">
  <h1 style="font-size: 45px;">Shop iPad</h1>
  <div class="container-text" style="display: flex;padding-top:30px">
    ...
    <a class="navbar-link" href="#accesories"" style="color:black;text-decoration:none;margin-right: 20px;">
      <p>Accesories</p>
    </a>
  </div>
</div>
...
<section id="models" style="padding-top:20px"> <!-- Remove the "#" symbol from the id -->
  ...
  <h2 style="padding-left:130px">All iPad.<span style="color:#6e6e73"> Which is right for you?</span></h2>
    <div id="carousel">
      <!-- first item -->
      <div class="item-f"></div>
      <!-- items -->
      @foreach ($viewData["products"] as $product)
      @if ($product->getCategory() === 'ipad')
...
<section id="accesories" style="padding-top:20px"> <!-- Remove the "#" symbol from the id -->
  <div class="container-fluid" style="margin-left: -40px">
    <h2 style="padding-left:130px">Accessories.<span style="color:#6e6e73"> Made for iPad.</span></h2>
    <div id="carousel">
      <!-- first item -->
      <div class="item-f"></div>
      <!-- items -->
      <div class="item" style="height: 435px; min-width:fit-content; width:300px">
        <div class="c-header">
          <h2 style="padding-top: 20px; padding-left:20px; padding-bottom:0">Get the most<br>from iPad.</h2>
        </div>
        <div class="c-img">
